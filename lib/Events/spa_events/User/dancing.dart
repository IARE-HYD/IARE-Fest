        ...
        child: RichText(
          text: TextSpan(
            ...
            children: <TextSpan>[
              ...
              TextSpan(
                  text:
                      'Participants should be undergraduate engineering students from any discipline with a team of Minimum 6 members.\n',
                  style: TextStyle(
              ...
              TextSpan(
                text:
                    'Costumes and music tracks must be approved by the Organizing Committee, one week prior to the event.\n',
                style: TextStyle(
              ...
              TextSpan(
                text:
                    'Dance performance should be in one shot and the camera should not move.\n',
                style: TextStyle(
                    color: Colors.black, fontSize: 18.0, fontFamily: 'Nunito'),
              ),
              TextSpan(
              ...
              TextSpan(
                text:
                    'Music/ Artist credits must be given at the end of the video.\n',
                style: TextStyle(
                    color: Colors.black, fontSize: 18.0, fontFamily: 'Nunito'),
              ),
              TextSpan(
              ...
              TextSpan(
                text:
                    ' Obscenity and vulgarity of any form will lead to immediate disqualification.\n',
                style: TextStyle(
                    color: Colors.black, fontSize: 18.0, fontFamily: 'Nunito'),
              ),
              TextSpan(
              ...
              TextSpan(
                text:
                    'The video should be 3-4 minutes in a continuous mode without any editing.\n',
                style: TextStyle(
                    color: Colors.black, fontSize: 18.0, fontFamily: 'Nunito'),
              ),
            ],
